...
@Component({
  selector: 'app-category-gaming',
  templateUrl: './category-gaming.component.html',
  styleUrls: ['./category-gaming.component.scss']
})
export class CategoryGamingComponent implements OnInit {
